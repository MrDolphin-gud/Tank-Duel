...
public class EnemyController : MonoBehaviour
{
    ...
    void PlaceMine()
    {
        // Mayın prefabı ve yerleştirme noktası varsa mayını yerleştirir
        if (minePrefab && minePoint)
        {
            ...
            // Tankın üzerindeki ve altındaki tüm Colliderları alır
            Collider[] tankColliders = GetComponentsInChildren<Collider>();
            
            // Mayının üzerindeki ve altındaki tüm Colliderları alır
    ...
    IEnumerator RecoilAnimation()
    {
        ...
        // Namluyu orijinal pozisyonuna yerleştirir
