...
public class TankController : MonoBehaviour
{
    ...
    void Update()
    {
        // AI kontrolündeyse oyuncu girdilerini işleme
        if (isAI)
        {
            return;
        } 
        ...
        // Bu sayede A'ya basınca tankın arkası sola D'ye basınca sağa gider.
        if (moveInput < -0.1f)
        {
    ...
    void PlaceMine()
    {
        ...
        {
            Instantiate(minePrefab, minePoint.position, Quaternion.identity);
        }
    }
    ...
    IEnumerator ActivateShield()
    {
        ...
        GetComponent<Renderer>().material.color = isAI ? Color.red : Color.darkGreen; 
